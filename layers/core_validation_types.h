...
class PIPELINE_STATE : public BASE_NODE {
   public:
    ...
    inline bool isGraphicsPipeline() {
        return graphicsPipelineCI.sType == VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_CREATE_INFO;
    }

    inline bool isComputePipeline() {
        return computePipelineCI.sType == VK_STRUCTURE_TYPE_COMPUTE_PIPELINE_CREATE_INFO;
    }

    inline bool isRayTracingPipeline() {
        return raytracingPipelineCI.sType == VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_CREATE_INFO_NV;
    }
};
